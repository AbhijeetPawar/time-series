...
class AnalysisTest extends FunSpec {
  describe("PriceRatio") {
    it("should create identity analysis for a priceRatio") {
      ...
      assert(priceRatio.analysis() === Analysis.Analysis(priceRatio, 1, 1.805, 1.805, 1.805))
    }
  }
  ...
  describe("Analysis") {
    it("should stringify analysis") {
      ...
      val analysis = Analysis.Analysis(priceRatio, 1, 1.80215, 1.80215, 1.80215)
    ...
    it("should round up decimal precision to 5 digits") {
      ...
      val analysis = Analysis.Analysis(priceRatio, 1, 1.80215078, 1.802156789, 1.8021567890)
    ...
    it("should trim tailing zeros") {
      ...
      val analysis = Analysis.Analysis(priceRatio, 1, 1.80200, 1.80200, 1.80200)
